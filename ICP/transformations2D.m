...
angle = pi/4;
A2 = [cos(angle) -sin(angle) 0; sin(angle) cos(angle) 0; 0 0 1];
...
% -----
% Concatenate the transformations in different orders
...
A3 = [cos(angle) -sin(angle) 2; sin(angle) cos(angle) 3; 0 0 1];
